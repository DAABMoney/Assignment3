...
<html lang="en">
  <head>
    ...
    <title>RsND Automotive Ltd. - Subscriber Information</title>
...
<br/>
<br/>
<h2 class="text-center">Subscriber's Information</h2>
<p style="text-align:left;">
&nbsp;&nbsp;<img src="<?php echo empty($result['image_path']) ? "files/blank.png" : $result['image_path']; ?>
" class="rounded" style="width: 15%; height: 15%">
<div class="card" style="width: 30rem;">
    <div class="media-body">
        <h2 class="card-title">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $result['first_name'] . ' ' . $result['last_name'];?>
        </h2>
        <h2 class="card-subtitle mb-2 text-mute">
        ...
        <p class="card-text">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Address Line 1: <?php echo $result['address1'];?>
        </p>
        <p class="card-text">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Address Line 2: <?php echo $result['address2'];?>
        </p> 
    </p>   
    </div>
</div>
